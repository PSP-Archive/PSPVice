...
int init_main(void)
{
    ...
    printf("CK : romset_init\n");

    romset_init();

    printf("CK : autres inits\n");
    ...
    printf("CK : keyboard_init\n");

    keyboard_init();

    printf("CK : joystick_init\n");
