...
{
  {"PSPVICE 1.2 - VICE 1.22",     (int(*)(void*, void*, int)) NULL,                 NULL,             NULL,            (void(*)(void*, int, int)) NULL,          NULL, 0, 0, NULL},
