...
static void interrupt_set_irq(interrupt_cpu_status_t *cs,
...
static void interrupt_set_nmi(interrupt_cpu_status_t *cs,
                                     unsigned int int_num,
                                     int value, CLOCK cpu_clk)
{
}
...
/* Change the interrupt line state: this can be used to change both NMI
   ...
   like the old `setirq()').  */
static void interrupt_set_int(interrupt_cpu_status_t *cs, int int_num,
